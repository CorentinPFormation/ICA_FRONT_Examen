      ...
      sections: [
        {
          ...
          children: [
            ...
            new Paragraph({children: [new Bookmark({id: "documentType", children: [new TextRun({text: "1. Type(s) de document", font: font, size: 42, color: '714C6C'})]})], pageBreakBefore: true}),
            table,
            new Paragraph({}),new Paragraph({}),new Paragraph({}),
            new Paragraph({children: [new Bookmark({id: "hookName", children: [new TextRun({text: "2. Nom du hook", font: font, size: 42, color: '714C6C'})]})]}),
            table2,
            new Paragraph({}),new Paragraph({}),new Paragraph({}),
            new Paragraph({children: [new Bookmark({id: "hookDescription", children: [new TextRun({text: "3. Description du hook", font: font, size: 42, color: '714C6C'})]})]}),
            table3,
            new Paragraph({}),new Paragraph({}),new Paragraph({}),
            new Paragraph({children: [new Bookmark({id: "hookEvents", children: [new TextRun({text: "4. Hook’s events (Don’t add action !) ", font: font, size: 42, color: '714C6C'})]})], pageBreakBefore: true}),
            table4,
            ...
            new Paragraph({}),new Paragraph({}),new Paragraph({}),
            new Paragraph({children: [new Bookmark({id: "identiryUser", children: [new TextRun({text: "6.1 Identity user (depending on the phases to be tested)", font: font, size: 28, color: 'FF0000'})]})]}),
            table6,
            new Paragraph({}),new Paragraph({}),new Paragraph({}),
